...
$this->tokyocards = [
  '1' => [
    ...
    'gaintotal' => '3<div class="pvtool"></div> per [<div class="ytool decal"></div><div class="btool decal"></div>]',
  ],
  ...
  '7' => [
    ...
    'text3' => clienttranslate('This bonus scores 3 <div class="littlepvtool"></div> for each day spent only in Tokyo'), //icon
