    ...
    class CardTokyo extends APP_GameClass
{
    ...
    public static function Tokyo_15($player_id, $day)
    {
        $ret = letsgotojapan::$instance->EtatToken($player_id);
    ...
    public static function Tokyo_16($player_id, $day)
    {
        $ret = letsgotojapan::$instance->EtatToken($player_id);
    ...
    public static function Tokyo_17($player_id, $day)
    {
        $ret = letsgotojapan::$instance->EtatToken($player_id);
    ...
    public static function Tokyo_61($player_id, $day)
    {
        $ret = letsgotojapan::$instance->EtatToken($player_id);
