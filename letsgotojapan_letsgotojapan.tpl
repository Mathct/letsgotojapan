...
var jstpl_tokyo1tool='<div class="hautdecarte"><div>${gain}</div><div style="font-size: 30px; font-weight: bold;">${gainpv}</div></div><div style="text-align: center; font-weight: bold;">${name}</div><div style="text-align: center;">${text1}</div><br><div style="text-align: center; font-weight: bold;">${text2}</div><div class="prerequis"><div style="font-weight: bold;">If:&nbsp;</div><div style="text-align: center;">${prerequis}</div></div><div style="text-align: center;">${text3}</div><br><div style="text-align: center; font-weight: bold;">Then:</div><div style="text-align: center; font-size: 30px; font-weight: bold;">${gaintotal}</div>';
