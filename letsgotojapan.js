...
/////////////////////////////////////////////////////////////////////////////////  
                    ...
                    for( var player_id in gamedatas.players )   
                        {
                            ...
                            if (gamedatas.countplayers == 1)
                            {
                                if(gamedatas.lvl == 1)
                                {
                                    ...
                                    var info = _('Easy level: Your opponent must meet the requirements of their "Highlight of the Day" bonuses in order to score them. They do not use Train tokens.');
                                ...
                                {
                                    dojo.place( this.format_block('jstpl_infolvl', {id: player_id} ), player_board_div );
                                    var info = _('Normal level: Your opponent always scores their "Highlights of the Day". They do not use train tokens.');
                                    $('infolvl_'+player_id).innerHTML = info;
                                ...
                                {
                                    dojo.place( this.format_block('jstpl_infolvl', {id: player_id} ), player_board_div );
                                    var info = _('Difficult level: Your opponent always scores their "Highlights of the Day" and places a Luxury Train token each time they travel.');
                                    $('infolvl_'+player_id).innerHTML = info;
                    ...
                    if (gamedatas.turn == 14)
                        {
                            ...
                            dojo.query("#mask_turn").addClass("hidden");
                            dojo.query("#mask_hand").addClass("hidden");
                ...
                if ((gamedatas.maxtrip[0] == 3)&&(gamedatas.phase[0] == "SoloExtraWalkStep2"))
                    {
    
                        var agent = document.querySelector('.playerview_agent');
                            agent.style.top = "1470px";
    
                    }

                if ((gamedatas.maxtrip[0] == 4)&&(gamedatas.phase[0] != "SoloPhase1Step2")&&(gamedatas.phase[0] != "SoloPhase2Step2"))
                    {
    
                        var agent = document.querySelector('.playerview_agent');
                            agent.style.top = "1315px";
                            console.warn('test1')
                                    ...
                                    if(args[this.getCurrentPlayerId()][0].buttons[nb].startsWith("cardbouton_1"))
                                        {
                                            ...
                                            var texteif = _(this.gamedatas.textes[1].name);
                                            var textethen = _(this.gamedatas.textes[2].name);
                                            ...
                                            if((card>=1)&&(card <= 10))
                                                {
                                                    ...
                                                    var html = '<div class="toolt"><div class="cardtoolt cardbleu">'+this.format_block('jstpl_tokyo1tool',{texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                                            ...
                                            if((card>=41)&&(card <= 50))
                                                {
                                                    ...
                                                    var html = '<div class="toolt"><div class="cardtoolt cardbleu">'+this.format_block('jstpl_tokyo2tool',{texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                                                    this.addTooltipHtml(args[this.getCurrentPlayerId()][0].buttons[nb], html,1000);
                                                }
                                            ...
                                            if((card>=71)&&(card <= 80))
                                                {
                                                    ...
                                                    {
                                                    var html = '<div class="toolt"><div class="cardtoolt cardjaune">'+this.format_block('jstpl_tokyo2tool',{texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                                                    }
                                                    this.addTooltipHtml(args[this.getCurrentPlayerId()][0].buttons[nb], html,1000);
                                                }
                                            ...
                                            if((card>=1)&&(card <= 10))
                                                {
                                                    ...
                                                    this.addActionButton(args[this.getCurrentPlayerId()][0].buttons[nb], `<div class="cardbouton" style="background-image: url(${img}); background-position-y: 0%; background-position-x: ${((card-1)*(-100))}%;"></div>`, 'onOpButton', null, null, 'none');
                                                    var html = '<div class="toolt"><div class="cardtoolt cardrose">'+this.format_block('jstpl_kyoto1tool',{texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                                                    this.addTooltipHtml(args[this.getCurrentPlayerId()][0].buttons[nb], html,1000);
                                                }
                                            ...
                                            if((card>=41)&&(card <= 50))
                                                {
                                                    ...
                                                    this.addActionButton(args[this.getCurrentPlayerId()][0].buttons[nb], `<div class="cardbouton" style="background-image: url(${img}); background-position-y: 0%; background-position-x: ${((card-41)*(-100))}%;"></div>`, 'onOpButton', null, null, 'none');
                                                    var html = '<div class="toolt"><div class="cardtoolt cardrose">'+this.format_block('jstpl_kyoto2tool',{texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                                                    this.addTooltipHtml(args[this.getCurrentPlayerId()][0].buttons[nb], html,1000);
                                                }
                                            ...
                                            if((card>=71)&&(card <= 80))
                                                {
                                                    ...
                                                    if(card == 71)
                                                    {
                                                    var html = '<div class="toolt"><div class="cardtoolt cardrose">'+this.format_block('jstpl_kyoto2tool',{texteif: texteif, textethen: textethen, texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                                                    }
                                                    else
                                                    {
                                                    var html = '<div class="toolt"><div class="cardtoolt cardjaune">'+this.format_block('jstpl_kyoto2tool',{texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                                                    }
                                                    this.addTooltipHtml(args[this.getCurrentPlayerId()][0].buttons[nb], html,1000);
                                                }
                                        }
                                        ...
                                        if(args[this.getCurrentPlayerId()][0].buttons[nb] == "easy")
                                            {
                                                ...
                                                var texteasy = _('Your opponent must meet the requirements of their "Highlight of the Day" bonuses in order to score them. They do not use Train tokens.');
                                        ...
                                        if(args[this.getCurrentPlayerId()][0].buttons[nb] == "normal")
                                            {
                                                ...
                                                var textnormal = _('Your opponent always scores their "Highlights of the Day". They do not use train tokens.');
                                        ...
                                        if(args[this.getCurrentPlayerId()][0].buttons[nb] == "difficult")
                                            {
                                                ...
                                                var textdifficult = _('Your opponent always scores their "Highlights of the Day" and places a Luxury Train token each time they travel.');
            ...
            addCardTokyoHand: function( id, card, ville, location, player )  
            {
                ...
                if ((player == this.getCurrentPlayerId())||(this.gamedatas.countplayers == 1))
                {
                    ...
                    if((card >=71)&&(card <=80))
                    {
                        ...
                        {
                        var html = '<div class="toolt"><div class="cardtoolt cardjaune">'+this.format_block('jstpl_tokyo2tool',{x: (card-71)*(-100), y: -300, texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                        }
                        this.addTooltipHtml( 'card_'+ville+'_'+id, html,1000);
            ...
            addCardKyotoHand: function( id, card, ville, location, player )  
            {
                ...
                if ((player == this.getCurrentPlayerId())||(this.gamedatas.countplayers == 1))
                {
                    ...
                    if((card >=71)&&(card <=80))
                    {
                        ...
                        {
                        var html = '<div class="toolt"><div class="cardtoolt cardjaune">'+this.format_block('jstpl_kyoto2tool',{x: (card-71)*(-100), y: -300, texteif: texteif, textethen: textethen, name: name, town: town, text1: text1, text2: text2, text3: text3, gain: gain, gainpv: gainpv, prerequis: prerequis, gaintotal: gaintotal})+'</div></div>';
                        }
                        this.addTooltipHtml( 'card_'+ville+'_'+id, html,1000);
...
/////////////////////////////////////////////////////////////////////////////////  
            ...
            if (this.gamedatas.countplayers[0]==1)
                {
                    ...
                    if (element && element.classList.contains('hidden')) 
                    {
                        ...
                        else
                        {
                            ...
                            element2.style.top = "850px";
                            element3.style.top = "880px";
                            element4.style.top = "1150px";
                    ...
                    else 
                    {
                        ...
                        else
                        {
                            ...
                            element2.style.top = "700px";
                            element3.style.top = "730px";
                            element4.style.top = "1000px";
            ...
            {   
                ...
                if (this.gamedatas.countplayers[0]==1)
                {
                    // compteur de cart et selectable par colone
                    ...
                    if (element3 && element3.classList.contains('switch')) 
                    {
                        ...
                        /*element2.style.top = (850 + (maxCount-1)*52)+"px";
                        element3.style.top = (880 + (maxCount-1)*52)+"px";*/
                        element4.style.top = (1150 + (maxCount-1)*52)+"px";
                        element2.style.top = "162px";
                        element3.style.top = "190px";
                        //element4.style.top = "1150px";
                    ...
                    else 
                    {
                        ...
                        if (maxCount==4)
                        {
                        element2.style.top = (850 + 9 + (maxCount-1)*52)+"px"; //+9 pour 61 au lieu de 52
                        element3.style.top = (880 + 9+(maxCount-1)*52)+"px";
                        element4.style.top = (1150 + 9+(maxCount-1)*52)+"px";
                        }
                        //element2.style.top = "850px";
                        //element3.style.top = "880px";
                        //element4.style.top = "1150px";
...
/////////////////////////////////////////////////////////////////////////////////  
                                    ...
                                    if (element3 && element3.classList.contains('switch'))
                                        {
                                                ...
                                                element2.style.top = "902px";
                                                element3.style.top = "932px";
                                    ...
                                    if (element3 && element3.classList.contains('switch'))
                                        {
                                                ...
                                                element2.style.top = "954px";
                                                element3.style.top = "986px";
                                            
                                        } 
            
                                }

                            if(notif.args.maxtrip == 4)
                            {
                                var agent = document.querySelector('.playerview_agent');
                                agent.style.top = "1315px";
                                ...
                                if (element3 && element3.classList.contains('switch'))
                                    {
                                            ...
                                            element2.style.top = "1015px";   //+61 au lieu de +52
                                            element3.style.top = "1045px";
            ...
            notif_movetoken: function( notif )
            {
                ...
                if(notif.args.type == 'r')
                {
                    ...
                    this.slideToObject( 'marqueur_r_'+notif.args.player, 'marqueurposition_'+notif.args.score+'_1_'+notif.args.player,400).play();
                ...
                if(notif.args.type == 'g')
                    {
                        ...
                        this.slideToObject( 'marqueur_g_'+notif.args.player, 'marqueurposition_'+notif.args.score+'_2_'+notif.args.player,400).play();
                ...
                if(notif.args.type == 'p')
                    {
                        ...
                        this.slideToObject( 'marqueur_p_'+notif.args.player, 'marqueurposition_'+notif.args.score+'_3_'+notif.args.player,400).play();
                ...
                if(notif.args.type == 'y')
                    {
                        ...
                        this.slideToObject( 'marqueur_y_'+notif.args.player, 'marqueurposition_'+notif.args.score+'_4_'+notif.args.player,400).play();
                        if(notif.args.plus == 1)
                        {
                ...
                if(notif.args.type == 'b')
                    {
                        ...
                        this.slideToObject( 'marqueur_b_'+notif.args.player, 'marqueurposition_'+notif.args.score+'_5_'+notif.args.player,400).play();
